...
require_once('m-links-link_id-get.php');

require_once('m-links-link_id-tags-tag-delete.php');

require_once('m-links-link_id-tags-get.php');
require_once('m-links-link_id-tags-post.php');

require_once('m-links-link_id-put.php');
require_once('m-links-link_id-delete.php');
 ?>
